  ...
  return (
    <div className="w-full max-w-4xl mx-auto text-center py-12">
      ...
      <div className="flex flex-wrap justify-center items-center gap-6">
        {contactLinks.map(({ href, color, icon, label }) => (
          <motion.a
            key={label}
            href={href}
            target="_blank"
            ...
            className={`bg-white p-4 rounded-full shadow-lg hover:bg-${color} hover:text-white transition-all duration-300 transform hover:scale-110`}
            aria-label={label}
          >
            {icon}
          </motion.a>
